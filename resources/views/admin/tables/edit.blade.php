  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="flex  m-2 p-2">
        <a href="{{ route('admin.tables.index') }}" class="px-4 py-2 text-white bg-gray-500 hover:bg-gray-700 rounded-lg">Back</a>
      </div>
      
      <div class="m-2 p-4 bg-slate-100 rounded">
        <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-2">
          <h2 class="text-4xl font-bold dark:text-white">Edit Table</h2>
          <form method="POST" action="{{ route('admin.tables.update', $table->id) }}">
            ...
            <div class="sm:col-span-6 mb-2">
              ...
              <div class="mt-1">
                <input type="text" id="name" name="name" value="{{ $table->name }}" class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" autofocus />
              </div>
              @error('name')
            ...
            <div class="sm:col-span-6 mb-2">
              ...
              <div class="mt-1">
               <select id="status" name="status" class="rounded-md bg-white border border-gray-400 block w-full mt-1">
            ...
            <div class="sm:col-span-6 mb-2">
              ...
              <div class="mt-1">
                <select id="location" name="location" class="rounded-md bg-white border border-gray-400 block w-full mt-1">
