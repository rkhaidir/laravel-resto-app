        ...
        <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-2">
          ...
          <form method="POST" action="{{ route('admin.reservations.store') }}">
            ...
            <div class="sm:col-span-6 mb-2">
              ...
              <div class="mt-1">
                <input type="text" id="first_name" name="first_name" class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" autofocus />
              </div>
              @error('first_name')
            ...
            <div class="sm:col-span-6 mb-2">
              ...
              <div class="mt-1">
                <input type="text" id="guest_number" name="guest_number" class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5"  />
              </div>
              @error('guest_number')
                <div class="text-small text-red-400">{{ $message }}</div>
              @enderror
